  ...
  <div class="wrapper">
    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled components">
        <img src="{{ asset('img/uploaded_img/' . Auth::user()->foto) }}" class="rounded-circle ml-3" width="120px" height="120px">
        <p class="lead text-primary font-weight-bold">Welcome, {{ Auth::user()->nama }}!</p>
        <li class="active">
        ...
        <li>
          <a href="{{ route('admin.akun') }}"><i class="fas fa-user-alt mr-2"></i> Akun</a>
        </li>
        <li class="nav-item">
