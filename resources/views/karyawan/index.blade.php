...
<head>
  ...
  <link rel="icon" href="../img/login_icon.png" type="image/png">
...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto align-items-center">
          <li class="nav-item mr-4">
            <p class="font-weight-bold lead mt-3">Halo, {{ Auth::user()->nama }}</p>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link btn btn-outline-warning text-white px-3" href="{{ route('logout') }}">
  ...
  <div class="container">
    ...
    <div class="row karyawan-container">
        ...
        <div class="card absen-card text-center my-3" style="width: 18rem;">
          ...
          <div class="card absen-card" style="width: 18rem;">
            <div class="card-body">
              ...
              <form action="{{ route('tambah.absensi') }}" method="POST" enctype="multipart/form-data">
                @csrf
      ...
      <div class="col-md-6 text-center">
        <img src="../img/karyawan_illustration.jpg" alt="ilustrasi" class="illustration">
    ...
    <div class="row mb-5">
        <div class="col-md-12 table-responsive">
            <table class="table table-hover text-center">
                ...
                <tbody>
                    @php
                        $absensiData = \App\Models\Absensi::all();
                    @endphp
                    @foreach ($absensiData as $absensi)
                        <tr>
                            ...
                            <td>{{ $absensi->pesan }}</td>
                            <td>
                                <img src="{{ asset('img/uploaded_img/' . $absensi->gambar) }}" alt="" width="75px">
                            </td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
            <form action="{{ route('cetak.absensi') }}" method="POST" target="_blank">
                @csrf
                <input type="hidden" name="dari">
                <input type="hidden" name="sampai">
                <button type="submit" class="btn btn-outline-dark float-right" name="cetak">
  ...
  <footer class="text-center mt-5 py-3 bg-light">
    &copy; IT Angkatan 21 2023. All rights reserved.
  </footer>
  <!-- End of Footer -->
